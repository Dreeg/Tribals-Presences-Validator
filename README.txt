...
Estrarre la cartella "TPV" dove preferite (ad esempio in C:\Programmi avendo cos� C:\Programmi\tpv).
Creare un collegamento di "tpv.exe" dove vi fa pi� comodo (ad esempio sul Desktop).

Avviate con un doppioclick C:\Programmi\tpv\tpv.exe o il collegamento precedentemente creato.
Inserite la data della quale fare il controllo, usate le "/" come separatori e scrivete lo 0 se il numero � singolo (ad esempio 04/08).
